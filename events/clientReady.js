...
module.exports = (client) => {
  ...
  if (rulesChannel) {
    ...
    rulesChannel.send({ embeds: [rulesEmbed1] }).catch(() => {});
    rulesChannel.send({ embeds: [rulesEmbed2] }).catch(() => {});
    rulesChannel.send({ embeds: [rulesEmbed3] }).catch(() => {});
    rulesChannel.send({ embeds: [rulesEmbed4] }).catch(() => {});
    rulesChannel.send({ embeds: [rulesEmbed5] }).catch(() => {});
  }
};
